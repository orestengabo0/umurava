  ...
  return (
    <div className=" flex flex-col gap-2 items-center px-2">
      <div
        ...
        className={` flex flex-row items-center gap-3 py-2 px-3 w-[100%] rounded-md cursor-pointer ${
          tab === "dashboard" ? " bg-[#FFFFFF] " : ""
        }`}
      >
        <img src={tab === "dashboard" ? homIcon : home} className=" h-5 w-5 " />
        <span
          className={` font-workSans text-sm ${
            tab === "dashboard" ? "text-[#2B71F0]" : " text-white"
          }`}
        >
          Dashboard
        </span>
      ...
      <div
        onClick={() => handleNavigation("challenge", "/challenge")}
        className={` flex flex-row items-center gap-3 py-2 px-3 w-[100%] rounded-md cursor-pointer ${
          tab === "challenge" ? " bg-[#FFFFFF] " : ""
        }`}
      >
        <img
          src={tab === "challenge" ? challenge : chalIcon}
          className=" h-5 w-5 "
        />
        <span
          className={` font-workSans text-sm ${
            tab === "challenge" ? "text-[#2B71F0]" : " text-white"
          }`}
        >
      ...
      >
        <img
          src={tab === "community" ? community : comIcon}
          className=" h-5 w-5 "
        />
        <span
          className={` font-workSans text-sm ${
            tab === "community" ? "text-[#2B71F0]" : " text-white"
          }`}
        >
          Community
        </span>
